...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_filenames',
                       help="Path to the training filenames data")
    group.add_argument('-valid_src', required=True,
                       help="Path to the validation source data")
    group.add_argument('-valid_tgt', required=True,
                       help="Path to the validation target data")
    group.add_argument('-valid_filenames',
                       help="Path to the validataion filenames data")
